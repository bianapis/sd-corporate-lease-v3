...
/**
 * BQAdministerControlOutputModel
 */
public class BQAdministerControlOutputModel   {
  ...
  private String administerControlActionTaskReference = null;

  private Object administerControlActionTaskRecord = null;

  private String administerControlActionResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Administer instance control processing service call 
   * @return administerControlActionTaskReference
  **/

  public String getAdministerControlActionTaskReference() {
    return administerControlActionTaskReference;
  }

  public void setAdministerControlActionTaskReference(String administerControlActionTaskReference) {
    this.administerControlActionTaskReference = administerControlActionTaskReference;
  }
  ...
  **/
   ...
   * @return administerControlActionResponse
  **/

  public String getAdministerControlActionResponse() {
    return administerControlActionResponse;
  }

  public void setAdministerControlActionResponse(String administerControlActionResponse) {
    this.administerControlActionResponse = administerControlActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Administer instance (e.g. initialised, pending, active) 
