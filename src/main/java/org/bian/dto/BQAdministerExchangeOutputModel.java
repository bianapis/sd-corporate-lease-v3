...
/**
 * BQAdministerExchangeOutputModel
 */
public class BQAdministerExchangeOutputModel   {
  ...
  private String administerExchangeActionTaskReference = null;

  private Object administerExchangeActionTaskRecord = null;

  private String administerExchangeActionResponse = null;

  private String administerInstanceStatus = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to a Administer instance exchange service call 
   * @return administerExchangeActionTaskReference
  **/

  public String getAdministerExchangeActionTaskReference() {
    return administerExchangeActionTaskReference;
  }

  public void setAdministerExchangeActionTaskReference(String administerExchangeActionTaskReference) {
    this.administerExchangeActionTaskReference = administerExchangeActionTaskReference;
  }
  ...
  **/
   ...
   * @return administerExchangeActionResponse
  **/

  public String getAdministerExchangeActionResponse() {
    return administerExchangeActionResponse;
  }

  public void setAdministerExchangeActionResponse(String administerExchangeActionResponse) {
    this.administerExchangeActionResponse = administerExchangeActionResponse;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Administer instance (e.g. accepted, rejected, verified) 
   * @return administerInstanceStatus
  **/

  public String getAdministerInstanceStatus() {
    return administerInstanceStatus;
  }

  public void setAdministerInstanceStatus(String administerInstanceStatus) {
    this.administerInstanceStatus = administerInstanceStatus;
  }
