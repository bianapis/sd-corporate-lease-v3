...
/**
 * BQFulfillInitiateOutputModel
 */
public class BQFulfillInitiateOutputModel   {
  private String fulfillInstanceReference = null;

  private String fulfillInitiateActionReference = null;
  ...
  **/
   ...
   * @return fulfillInitiateActionReference
  **/

  public String getFulfillInitiateActionReference() {
    return fulfillInitiateActionReference;
  }

  public void setFulfillInitiateActionReference(String fulfillInitiateActionReference) {
    this.fulfillInitiateActionReference = fulfillInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Fulfill instance (e.g. initialised, pending, active) 
